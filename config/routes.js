module.exports.routes = {
    ...
    */
    ...
    'get /api/commission/templateinfo': 'CommissionController.templateinfo',
    ...
    //list shots
    'get /api/commission/shots': { controller: 'CommissionController', action: 'allshots', policy: 'apiauth', cors: true },
    //get template
    'get /api/commission/gettemplate/:id?': { controller: 'CommissionController', action: 'templateinfo', policy: 'apiauth', cors: true },
    //update template
    'post /api/commission/update/:id?': { controller: 'CommissionController', action: 'update', policy: 'apiauth', cors: true },
    //update shots live
    'post /api/commission/updateshots/:id?': { controller: 'CommissionController', action: 'updateshots', policy: 'apiauth', cors: true },
    //list seed templates
    'get /api/commission/seedtemplates': { controller: 'CommissionController', action: 'seedtemplates', policy: 'apiauth', cors: true },
    //get seed template
    'get /api/commission/getseedtemplate/:id?': { controller: 'CommissionController', action: 'getseedtemplate', policy: 'apiauth', cors: true },
    //my events
    'get /api/profile/mine': { controller: 'EventController', action: 'myevents', policy: 'apiauth', cors: true },
    //my profile details
    'get /api/profile/me': { controller: 'EventController', action: 'me', policy: 'apiauth', cors: true },

    //create new media
    'post /api/media/create': [{ policy: 'apiauth' }, { policy: 'apply_cors' }, { controller: 'MediaController', action: 'addmedia' }],

    'post /api/media/update/:id?': { controller: 'MediaController', action: 'update', policy: 'apiauth', cors: true },
    //upload media thumb
    'get /api/media/signuploadthumb/:id?': { controller: 'MediaController', action: 'uploadsignthumb', policy: 'apiauth', cors: true },
    'post /api/media/uploadthumbcomplete/:id?': { controller: 'MediaController', action: 's3notifythumb', policy: 'apiauth', cors: true },
    //upload media file
    'get /api/media/signupload/:id?': { controller: 'MediaController', action: 'uploadsign', policy: 'apiauth', cors: true },
    ...
    'get /api/post/editprogress/:id?': { controller: 'WatchController', action: 'editprogress', policy: 'apiauth', cors: true },
    'get /api/post/myedits': { controller: 'WatchController', action: 'myedits', policy: 'apiauth', cors: true },
    ...
    'get /api/shoot/acceptrole': { controller: 'EventController', action: 'acceptrole', policy: 'apiauth', cors: true },
    'get /api/shoot/acceptshot': { controller: 'EventController', action: 'acceptshot', policy: 'apiauth', cors: true },
    'get /api/shoot/connect/:id?': { controller: 'EventController', action: 'subscribe', policy: 'apiauth', cors: true },
    'get /api/shoot/join/:id?': { controller: 'EventController', action: 'sub', policy: 'apiauth', cors: true },
    'get /api/shoot/registerpush/:id?': { controller: 'EventController', action: 'registerpush', policy: 'apiauth', cors: true },
    'get /api/shoot/selectrole': { controller: 'EventController', action: 'chooserole', policy: 'apiauth', cors: true },
    'get /api/shoot/startrecording': { controller: 'EventController', action: 'startrecording', policy: 'apiauth', cors: true },
    'get /api/shoot/stoprecording': { controller: 'EventController', action: 'stoprecording', policy: 'apiauth', cors: true },


    'get /api/profile/contributed': { controller: 'EventController', action: 'mycontributions', policy: 'apiauth', cors: true },
    'get /api/editing/alledits/:id?': { controller: 'WatchController', action: 'alledits', policy: 'apiauth', cors: true },

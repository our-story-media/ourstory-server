...
bootleggerApp.controller("admin", [
  "$scope",
  "$bootleggerSails",
  "$timeout",
  "$sce",
  ...
  function (
    ...
    $scope.ordere = function (predicate) {
      $scope.reversee =
        $scope.predicatee === predicate ? !$scope.reversee : false;
    ...
    $scope.showedits = function () {
      ...
      socket.get("/event/admin_edits/").then(function (resp) {
    ...
    $scope.showshoots = function () {
      ...
      socket.get("/event/admin_events/").then(function (resp) {
    ...
    $scope.showusers = function () {
      ...
      socket.get("/event/admin_users/").then(function (resp) {
